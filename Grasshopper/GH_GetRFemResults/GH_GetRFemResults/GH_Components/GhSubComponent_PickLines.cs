...
{
    class GhSubComponent_PickLines : SubComponent
    {
        ...
        public GhSubComponent_PickLines(GhComponent_ObjectPicker _parent)
        {
            this.parent = _parent;
        }
        ...
        public override void SolveInstance(IGH_DataAccess DA, out string msg, out GH_RuntimeMessageLevel level)
        {
            ...
            parent.objectList = RFem.Select.PickLines(iModel);
        }
    }
}
