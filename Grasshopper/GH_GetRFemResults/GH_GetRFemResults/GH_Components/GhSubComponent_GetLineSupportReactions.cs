...
{
    class GhSubComponent_GetLineSupportReactions : SubComponent
    {
        ...
        public GhSubComponent_GetLineSupportReactions(GhComponent_GetSupportReactions _parent)
        {
            this.parent = _parent;
        ...
        {
            return "GetLineSupportReactions";
        }

        public override void registerEvaluationUnits(EvaluationUnitManager mngr)
        {
            EvaluationUnit evaluationUnit = new EvaluationUnit(name(), "LineSupportReactions", "Get line support reactions");
        ...
        DataTree<float>[] GetResults(List<LoadingCase> _loadingCase, out DataTree<Point3d> _locations)
        {
            ...
            for (int i = 0; i < _loadingCase.Count; i++)
            {
                ...
                string lineFilter = parent.objectList;

                // Get locations out
                DataTree<Point3d> locations = GetSupportReactions.GetLineSupportLocations(iModel, parent.iResults, _loadingCase[i].loadingIndex, lineFilter);
                if (_locations == null)
                {
                ...
                List<LineSupportForces[]> supportForceList = GetSupportReactions.GetLineSupportForceList(iModel, iResults, lineFilter);

                if (Fx)
                {
                    result = GetSupportReactions.GetLineSupportReactionsFloat(iModel, iResults, SupportReactions.Fx, _loadingCase[i].loadingIndex, supportForceList);
                ...
                if (Fy)
                {
                    result = GetSupportReactions.GetLineSupportReactionsFloat(iModel, iResults, SupportReactions.Fy, _loadingCase[i].loadingIndex, supportForceList);
                ...
                if (Fz)
                {
                    result = GetSupportReactions.GetLineSupportReactionsFloat(iModel, iResults, SupportReactions.Fz, _loadingCase[i].loadingIndex, supportForceList);
                ...
                if (Mx)
                {
                    result = GetSupportReactions.GetLineSupportReactionsFloat(iModel, iResults, SupportReactions.Mx, _loadingCase[i].loadingIndex, supportForceList);
                ...
                if (My)
                {
                    result = GetSupportReactions.GetLineSupportReactionsFloat(iModel, iResults, SupportReactions.My, _loadingCase[i].loadingIndex, supportForceList);
                ...
                if (Mz)
                {
                    result = GetSupportReactions.GetLineSupportReactionsFloat(iModel, iResults, SupportReactions.Mz, _loadingCase[i].loadingIndex, supportForceList);
